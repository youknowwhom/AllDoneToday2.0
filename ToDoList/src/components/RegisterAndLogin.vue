<template>
  <div class="body">
    <div class="box">
      ...
      <input type="submit" value="登录" class="login-button" @click.prevent="Login" />
...
.input[type="text"]:focus {
  background: url(../assets/image/user-focus.png) no-repeat 0% 50%;
  background-size: 30px 30px;
...
.input[type="password"] {
  background: url(../assets/image/password.png) no-repeat 1% 53%;
...
.input[type="password"]:focus {
  background: url(../assets/image/password-focus.png) no-repeat 1% 53%;
  background-size: 25px 25px;
