    ...
    <el-container class="profile-background">
        ...
        <div class="profile-container">
            ...
            <el-main v-if="filter == 'personal-info'" class="profile-main">
                ...
                <div class="info-item">
                    <el-col :span="6">
                        <p class="info-item-title"> 个性签名 </p>
                    </el-col>
                    <el-col :span="12">
                ...
                <div class="info-item">
                    <el-col :span="6">
                        <p class="info-item-title"> 性别 </p>
                    </el-col>
                    <el-col :span="12">
                        <p v-if="!modify"> {{ gender }} </p>
                        <el-select v-else v-model="gender" placeholder="在此选择性别">
                            <el-option v-for="item in ['男', '女']" :key="item" :value="item">
                            </el-option>
                        </el-select>
                    </el-col>
                </div>
                <div class="info-item">
                    <el-col :span="6">
                        <p class="info-item-title"> 生日 </p>
                    </el-col>
                    <el-col :span="12">
                        <p v-if="!modify"> {{ getBirthday }} </p>
                        <el-date-picker v-else v-model="birthday" type="date" placeholder="在此选择生日">
                        </el-date-picker>
                    </el-col>
                </div>
                <div class="info-item">
                    <el-col :span="6">
                        <p class="info-item-title"> 邮箱 </p>
                    </el-col>
                    <el-col :span="12">
