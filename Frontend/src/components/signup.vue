<template>
    <div class="body" onselectstart="return false;">
        <div class="box">
            ...
            <input type="email" placeholder="邮箱" class="input" v-model="EmailAddress" />
            ...
            <br />
            <input type="security-code" placeholder="验证码" class="input" v-model="SecurityCodeInput" />
            ...
            <input type="password" placeholder="新密码" class="input" v-on:input="JudgeThePassword"
                v-model="PasswordHash" />
            <div v-if="IsPasswordHashEmpty" class="password-error">密码不能为空</div>
            <br />
            <input type="password" placeholder="确认密码" class="input-again" v-on:input="JudgeThePasswordAgain"
                v-model="PasswordAgainHash" /><br />
            <div v-if="!IsPasswordAgainClear">
                <div v-if="!IsPasswordTrue" class="password-again-error">密码不一致</div>
                <div v-else class="password-true">正确</div>
            </div>
    ...
    methods: {
        ...
        async SignUp() {
            if (this.IsPasswordTrue) {
                ...
                this.IsFormValid = response.IsFormValid
                if (!this.IsFormValid) {
                    this.IsUsernameEmpty = response.IsUserNameEmpty
                    this.IsEmailAddressEmpty = response.IsEmailAddressEmpty
                    this.IsPasswordHashEmpty = response.IsPasswordEmpty
                    this.IsSecurityCodeEmpty = response.IsSecurityCodeEmpty
                }
                else {
                    this.IsSecurityCodeTrue = response.IsSecurityCodeTrue
                    this.IsUsernameTrue = response.IsUsernameTrue
                    //this.IsEmailTrue = response.IsEmailAddressTrue
